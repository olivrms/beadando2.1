...
function fuggveny(){
    ...
    document.getElementById("quiz").innerHTML=`<img src="kepek/quiz_eredmeny/${eredmeny}.jpg" alt="Zuko"><p class=quiz_a>A legjobban ${eredmeny}é-ra/re hasonlít az ízlésed</p>`
}